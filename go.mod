module github.com/gardener/gardener-extension-provider-gdc
...
require (
	...
	github.com/google/tink/go v1.7.1-0.20221117221331-86d32cd19d06
...
replace sigs.k8s.io/controller-tools => sigs.k8s.io/controller-tools v0.17.3
